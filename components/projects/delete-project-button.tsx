...
export function DeleteProjectButton({
  ...
  const [state, formAction] = useActionState(deleteProjectWithId, initialState);
  ...
  return (
    <div className="rounded-xl border border-red-200 bg-red-50 p-4">
      <p className="font-medium text-red-950">Excluir “{projectName}”?</p>

      <p className="mt-2 text-sm leading-6 text-red-800">
        O projeto e todas as suas tarefas serão excluídos permanentemente. Essa
      ...
      >
        ...
        <button
          ...
          className="rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >
          Cancelar
        </button>
      </form>
