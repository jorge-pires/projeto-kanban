...
export type { BoardTask } from "@/lib/tasks/board";
...
export function SortableProjectBoard({
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (!nextTasks) {
      setMessage("A tarefa já está nesta posição ou o destino é inválido.");
      return;
    }
    ...
    const updates = createTaskOrderUpdates(nextTasks);
